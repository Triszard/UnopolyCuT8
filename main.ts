...
function MultiDimArrayReader (num: number, num2: number, list: any[]) {
    Temp = list[num]
    TempErgebnis = Temp[num2]
    return TempErgebnis
}
basic.forever(function () {
    MultiDimArrayReader(1, 1, SpielKarten).showImage(0)
})
